        ...
        if root != current_directory and os.path.dirname(root) == current_directory:
            ...
            if rootName in ['4', '5', '6', '7', '8']:
                for folder_name in directories:
                    ...
                    l = f"{rootName}input_{folder_name}\t../benchmark/input-boolean-circuits/{rootName}/{folder_name}\t./lib\tTRUE\t1,7\t3\tlow\t2,2\t4\tTRUE\tC\t0\t[1,5]\t./results/input-boolean-circuits/{rootName}/{folder_name}"
